...
### Input Events
- [x] `inject_input_key_event` - Injects key event with duration
- [x] `press_button` - Presses button by name using keycode mapping

## Shell Tools

### Application Management
- [x] `launch_app` - Launches application via vmsgr
- [x] `terminate_app` - Terminates application via vlcm
